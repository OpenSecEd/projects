...
\begin{description}
  ...
  \item[Grade C] You fulfil all the \acp{ILO},
    you evaluations and designs are \emph{good} with \emph{some base} in theory 
    and, where applicable, the research literature and otherwise show 
    \emph{some} insights in how to use the building-blocks from the literature.

  \item[Grade A] You fulfil all the \acp{ILO},
    your evaluations and designs are \emph{extensive} and \emph{well-founded} 
    in theory and, where applicable, the research literature and otherwise show 
    \emph{deep} insights in how to use the building-blocks from the literature.
\end{description}
